...
OUTPUT_PATH = "emergency_test_output.mp4"
...
def main():
    ...
    specialist = EmergencySpecialist()
    frame_id = 0

    print("Running Emergency Vehicle Detection Test...")
    print("This detects ambulances, fire trucks, and police vehicles.")
    ...
    print("\nEmergency vehicles will be highlighted with red bounding boxes.")
